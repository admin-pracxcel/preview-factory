/**
 * Allied-health category — service-in-area landing page (treatment x suburb).
 *
 * e.g. "Sports Injury Rehabilitation in Chatswood"
 * Uses Service JSON-LD scoped to the suburb/treatment combination.
 */
...
export function ServiceAreaPage({
  ...
  if (loc)
    related.push({ label: `Physio in ${page.suburb}`, href: href(basePath, "locations", loc.slug) });
  ...
  return (
    <SiteShell site={site} basePath={basePath} jsonLd={jsonLd}>
      ...
      <CtaBand
        ...
        body="Same-day and next-day appointments often available. Registered physiotherapists, upfront fees."
        cta={cta}
      />
    </SiteShell>
  );

  ...
  return (
    <SiteShell site={site} basePath={basePath} jsonLd={jsonLd}>
      ...
      {site.home.testimonials?.length ? (
        <TestimonialsSection items={site.home.testimonials} heading="What our customers say" />
      ) : null}

      <CtaBand heading="Work with us" body="Get a fast, no-obligation quote today." cta={cta} />
    </SiteShell>
  );
}

/** Fitness-wellness category — about page. */
  ...
  return (
    <SiteShell site={site} basePath={basePath} jsonLd={jsonLd}>
      ...
      {site.home.testimonials?.length ? (
        <TestimonialsSection items={site.home.testimonials} heading="What clients say" />
      ) : null}

      <CtaBand heading="Train with us" body="Book a free consult and start your first week." cta={cta} />
    </SiteShell>
  );
}

/** Fitness-wellness category — location (suburb) page. */
    ...
    <SiteShell site={site} basePath={basePath} jsonLd={jsonLd}>
      ...
      <section className="py-14 sm:py-20">
        <div className="mx-auto max-w-4xl px-4 space-y-10">
          ...
          {page.benefits.length > 0 && (
            <BenefitsList items={page.benefits} heading={`Why ${page.suburb} clients train with us`} />
          )}
        </div>
      </section>
      ...
      {serviceCards.length > 0 && (
        <ServicesGrid
          ...
          basePath={basePath}
          heading={`Programs available in ${page.suburb}`}
          subheading={`Flexible sessions across ${page.suburb} and surrounding suburbs — bring your goals, we supply the plan.`}
        />
      )}
      ...
      <CtaBand
        heading={`Training in ${page.suburb}?`}
        body="Book a free consultation session — no obligation, just results."
        cta={cta}
      />
    </SiteShell>
  );

...
export const metadata = {
  title: "Websites for Gyms, PTs & Studios | Launcharoo",
  description:
    "A pro gym website live in 60 seconds. Personal trainers, CrossFit boxes, yoga, Pilates, martial arts. Class schedule, PT bios, free trial signups, built from your Google listing.",
  alternates: { canonical: "https://launcharoo.online/websites-for-gyms" },
};
...
const CONFIG: NicheHomeLandingConfig = {
  ...
  tag: "For gyms, PTs and studios",
  heroHeadline1: "A website your clients",
  heroHeadline2: "actually want to visit.",
  heroSub:
    "Personal trainers, CrossFit boxes, yoga studios, Pilates, martial arts. Class schedule, transformation gallery, free trial form. Live in under a minute.",
  ...
  faqs: [
    {
      ...
      a: "Yes. MindBody, Glofox, Fitbox, Xplor, Momence. Send us your widget or booking link after your preview goes live and we drop it into the schedule block within 2 hours.",
    },
    {
      q: "Can I add my 6-week challenge landing page?",
      a: "Yes. Every gym site comes with a challenge-style landing page you can activate. Just tell us the offer, price, and start date via SMS.",
    },
    {
      q: "How do I update my class times?",
      a: "SMS us. We update the schedule block within 2 hours. No portal, no admin.",
    },
    {
  ...
  ctaHeadline: "See your gym website in 60 seconds.",

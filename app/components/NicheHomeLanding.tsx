...
export interface NicheHomeLandingConfig {
  ...
  exampleHref: string;
  /** Screenshot / preview image used in the "See a live example" card. */
  exampleImage?: string;
  /** Alt text for the example image. */
  exampleAlt: string;
      ...
      <section className="bg-[#0A0F1E] py-24 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="block rounded-3xl border border-white/10 bg-white/5 overflow-hidden shadow-2xl shadow-black/50 hover:border-white/25 transition-colors group"
          >
            {/* Browser chrome */}
            <div className="flex items-center gap-2 bg-white/5 border-b border-white/10 px-4 py-3">
              ...
              <span className="hidden sm:flex items-center gap-1.5 text-xs text-white/50 group-hover:text-white transition-colors">
            ...
            <div className="relative bg-slate-950">
              {config.exampleImage ? (
                <Image
                  ...
                  alt={config.exampleAlt}
                  width={1600}
                  height={900}
                  className="w-full h-auto"
                />
              ) : (
                <div className="aspect-[16/9] flex items-center justify-center bg-gradient-to-br from-slate-800 via-slate-900 to-black">
                  <div className="text-center px-6">
                    <p className="text-blue-400 text-xs font-semibold uppercase tracking-widest">Live example</p>
                    <p className="text-white text-2xl font-bold mt-2">{config.exampleAlt}</p>
                    <p className="text-white/50 text-sm mt-3">Click to open in a new tab.</p>
                  </div>
                </div>
              )}
            </div>

    ...
    sections: [
      {
        ...
        body: "We list you consistently across Australia's top directories. Same name, address and phone everywhere. It sounds boring, but it's one of the strongest local ranking signals Google uses.",
      },
      {

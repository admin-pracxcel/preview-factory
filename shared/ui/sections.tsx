...
export function Hero({
  ...
  return (
    ...
    >
      ...
      {socialProof?.length ? (
        <div className="relative border-t border-white/15 bg-black/40 backdrop-blur">
          <ul className="mx-auto grid max-w-6xl grid-cols-2 gap-x-4 gap-y-4 px-4 py-5 sm:flex sm:flex-wrap sm:items-center sm:justify-between sm:py-6">

...
import { generateAndWrite, type GbpPayload } from "./index";

/* ------------------------------------------------------------------ payload */

const clearflowPlumbing: GbpPayload = {
...
async function main(): Promise<void> {
  try {
    ...
    console.log(
      "Grade with: node scripts/grade.mjs generator/output/clearflow-plumbing.json"
    );
  } catch (err) {
